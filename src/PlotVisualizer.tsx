...
export default class PlotVisualizer extends Component<PlotVisualizerProps, PlotVisualizerState> {
    constructor(props: PlotVisualizerProps) {
        ...
        this.state = {
            ...
            history: [],
            historyLimit: 50,
            axisKeys: [undefined, undefined, undefined],
        };
